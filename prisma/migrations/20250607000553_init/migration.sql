...
CREATE TABLE "Certificate" (
    ...
    "invalidAfter" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Course_title_description_idx" ON "Course"("title", "description");

-- CreateIndex
CREATE INDEX "CourseSection_title_idx" ON "CourseSection"("title");
...
-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_sectionId_fkey" FOREIGN KEY ("sectionId") REFERENCES "CourseSection"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserProgress" ADD CONSTRAINT "UserProgress_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserProgress" ADD CONSTRAINT "UserProgress_assessmentId_fkey" FOREIGN KEY ("assessmentId") REFERENCES "Assessment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
